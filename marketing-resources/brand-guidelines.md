# Brand Guidelines for LF Energy and Hosted Projects
...
LF Energy is hosted by the Linux Foundation. As part of LF Energy’s charter, it hosts multiple open source projects and initiatives for the benefit of energy stakeholders. The latest list of projects is at [https://tac.lfenergy.org/](https://tac.lfenergy.org/). 

Each project hosted at LF Energy is self-governed with oversight by the LF Energy Technical Advisory Committee (TAC) as outlined in the [charter](https://cdn.platform.linuxfoundation.org/agreements/lfenergy.pdf?__hstc=138353967.b831573db216edfe48aaf844b8438edd.1772811067428.1788514478931.1788528358352.220&__hssc=138353967.3.1788528358352&__hsfp=b6a3066d95f6dc2950b3c354723b04d2) and the TAC’s [project lifecycle guidelines](https://tac.lfenergy.org/process/lifecycle.html). The Linux Foundation is the legal entity that owns and manages the brand assets for the hosted projects. The copyrights in contributions to LF Energy’s hosted projects, such as source code and documentation, remain owned by the original authors and are licensed to the projects and downstream users under OSI approved open source licenses.
...
In addition to the generally applicable rules discussed in [The Linux Foundation Trademark Usage Guidelines](https://www.linuxfoundation.org/trademark-usage/?__hstc=138353967.b831573db216edfe48aaf844b8438edd.1772811067428.1788514478931.1788528358352.220&__hssc=138353967.3.1788528358352&__hsfp=b6a3066d95f6dc2950b3c354723b04d2) and [The Linux Foundation Branding Guidelines](https://www.linuxfoundation.org/brand-guidelines?__hstc=138353967.b831573db216edfe48aaf844b8438edd.1772811067428.1788514478931.1788528358352.220&__hssc=138353967.3.1788528358352&__hsfp=b6a3066d95f6dc2950b3c354723b04d2), there are a few specific rules that we ask everyone to follow when using trademarks or project names related to any projects hosted by LF Energy, or LF Energy itself.
...
* When using the LF Energy logo or the logo of an LF Energy hosted project, use only official artwork (which is publicly available at [https://artwork.lfenergy.org](https://artwork.lfenergy.org/)). If you require modification of existing artwork for a specific campaign or piece of collateral, please contact pr@lfenergy.org to discuss.   
* If a project provides a logo for use in an icon format, note that its use is intended only for use where an icon is most appropriate (such as within an application). Please work with pr@lfenergy.org to review if there are questions or concerns.

## Do I need permission to talk publicly about LF Energy or the hosted projects?

No. Anyone is free to talk publicly about LF Energy and its hosted projects without restriction. All we ask is that, when you use the organization’s and projects’ names, logos and trademarks in connection with providing goods and services, that you do so in an appropriate manner that is consistent with maintaining the goodwill associated with them. To help ensure this, we do request you contact us at pr@lfenergy.org for review for the following:
